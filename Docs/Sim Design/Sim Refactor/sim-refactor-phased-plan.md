# Phase 8: Simulation Engine Refactor - Phased Implementation Plan

## Executive Summary

**Current State**: Simulation system has strong infrastructure (Phase 5-6) but game mechanics implementation is only ~25% functional. Core issues: CSV data parsing incomplete, action execution stubbed, major systems (combat, mining, forge) minimally implemented, helpers non-functional, resource management incomplete.

**Goal**: Achieve 80%+ simulation accuracy for Time Hero gameplay through systematic refactoring of the simulation engine.

**Timeline**: 7 sub-phases building on each other, estimated 10-15 days total effort.

---

## Phase Summary & Testing Guide
